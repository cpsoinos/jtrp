describe WebhookProcessorJob do
  ...
  let(:remote_order) do
    DeepStruct.wrap(
    {"href"=>"https://www.clover.com/v3/merchants/DEF456/orders/JKL987", "id"=>"JKL987", "currency"=>"USD", "employee"=>{"id"=>"QQYBQFPPQ8D0C"}, "total"=>51000, "taxRemoved"=>false, "isVat"=>false, "state"=>"locked", "manualTransaction"=>false, "groupLineItems"=>true, "testMode"=>false, "createdTime"=>1468069942000, "clientCreatedTime"=>1468069942000, "modifiedTime"=>1468074202000, "lineItems"=>{"elements"=>[{"id"=>"MNO654", "orderRef"=>{"id"=>"JKL987"}, "item"=>{"id"=>"MNO654"}, "name"=>"1 Small Stool", "code"=>"abc", "price"=>1000, "printed"=>false, "createdTime"=>1468074064000, "orderClientCreatedTime"=>1468069942000, "exchanged"=>false, "refunded"=>false, "isRevenue"=>true}, {"id"=>"PQR432", "orderRef"=>{"id"=>"JKL987"}, "item"=>{"id"=>"PQR432"}, "name"=>"2 Identical Dressers", "code"=>"def", "price"=>35000, "printed"=>false, "createdTime"=>1468074148000, "orderClientCreatedTime"=>1468069942000, "exchanged"=>false, "refunded"=>false, "isRevenue"=>true}, {"id"=>"STU123", "orderRef"=>{"id"=>"PHM4QATAVKYDC"}, "item"=>{"id"=>"STU123"}, "name"=>"2 Overstuffed Chairs 1 Ottoman", "code"=>"ghi", "price"=>15000, "printed"=>false, "createdTime"=>1468074202000, "orderClientCreatedTime"=>1468069942000, "exchanged"=>false, "refunded"=>false, "isRevenue"=>true}]}, "device"=>{"id"=>"43fb2150-4593-4a67-a7c9-fb19325bded9"}}
    )
  end
  let!(:item1) { create(:item, :active, remote_id: "MNO654", token: "abc", listing_price_cents: 4000) }
  let!(:item2) { create(:item, :active, remote_id: "PQR432", token: "def", listing_price_cents: 7000) }
  let!(:item3) { create(:item, :active, remote_id: "STU123", token: "ghi", listing_price_cents: 40000) }
